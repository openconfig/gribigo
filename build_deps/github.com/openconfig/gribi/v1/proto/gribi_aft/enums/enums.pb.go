...
// 	protoc        v6.31.1
// source: build_deps/github.com/openconfig/gribi/v1/proto/gribi_aft/enums/enums.proto
...
func (OpenconfigAftTypesEncapsulationHeaderType) Descriptor() protoreflect.EnumDescriptor {
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes[0].Descriptor()
}

func (OpenconfigAftTypesEncapsulationHeaderType) Type() protoreflect.EnumType {
	return &file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes[0]
}
...
func (OpenconfigAftTypesEncapsulationHeaderType) EnumDescriptor() ([]byte, []int) {
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescGZIP(), []int{0}
}
...
func (OpenconfigMplsTypesMplsLabelEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes[1].Descriptor()
}

func (OpenconfigMplsTypesMplsLabelEnum) Type() protoreflect.EnumType {
	return &file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes[1]
}
...
func (OpenconfigMplsTypesMplsLabelEnum) EnumDescriptor() ([]byte, []int) {
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescGZIP(), []int{1}
}
...
func (OpenconfigPacketMatchTypesIPPROTOCOL) Descriptor() protoreflect.EnumDescriptor {
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes[2].Descriptor()
}

func (OpenconfigPacketMatchTypesIPPROTOCOL) Type() protoreflect.EnumType {
	return &file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes[2]
}
...
func (OpenconfigPacketMatchTypesIPPROTOCOL) EnumDescriptor() ([]byte, []int) {
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescGZIP(), []int{2}
}

var File_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto protoreflect.FileDescriptor

const file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDesc = "" +
	"\n" +
	"Kbuild_deps/github.com/openconfig/gribi/v1/proto/gribi_aft/enums/enums.proto\x12\x0fgribi_aft.enums\x1a0github.com/openconfig/ygot/proto/yext/yext.proto*\xca\x04\n" +
...
var (
	file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescOnce sync.Once
	file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescData []byte
)

func file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescGZIP() []byte {
	file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescOnce.Do(func() {
		file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDesc), len(file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDesc)))
	})
	return file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDescData
}

var file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_goTypes = []any{
...
var file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_depIdxs = []int32{
...
func init() { file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_init() }
func file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_init() {
	if File_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDesc), len(file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_goTypes,
		DependencyIndexes: file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_depIdxs,
		EnumInfos:         file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_enumTypes,
	}.Build()
	File_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto = out.File
	file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_goTypes = nil
	file_build_deps_github_com_openconfig_gribi_v1_proto_gribi_aft_enums_enums_proto_depIdxs = nil
}
